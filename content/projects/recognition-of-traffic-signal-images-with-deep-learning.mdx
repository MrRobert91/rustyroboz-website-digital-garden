...
description: "A final-degree deep-learning project that trains a CNN to recognise traffic signs, developed after an early encounter with neural networks at university."
