...
description: >-
  At the end of my degree at the university I went to a series of seminars that
  dealt with the topic of Deep Learning, and I found it fascinating how an
  algorithm could learn just by passing it a sufficient number of ex...
...
draft: false
featured: false
coverImage: 'https://i.ytimg.com/vi/zPINu6zXo9A/hqdefault.jpg'
readingTime: 2 min
status: completed
tech:
  - Python
...
links:
  github: >-
    https://github.com/MrRobert91/traffic_sign_machine_learning/blob/master/tfg_david_robert.pdf
media:
  - type: youtube
    id: zPINu6zXo9A
  ...
  - type: image
    src: >-
      /images/projects/recognition-of-traffic-signal-images-with-deep-learning/image-01.png
    alt: Recognition of traffic signal images with deep learning image 1
  - type: image
    src: >-
      /images/projects/recognition-of-traffic-signal-images-with-deep-learning/image-02.png
    alt: Recognition of traffic signal images with deep learning image 2
  - type: image
    src: >-
      /images/projects/recognition-of-traffic-signal-images-with-deep-learning/image-03.png
    alt: Recognition of traffic signal images with deep learning image 3
---
