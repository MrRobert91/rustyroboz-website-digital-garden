...
description: >-
  The goal is to generate random prices for [Rusty Roboz's collection of
  NFTs](/projects/nft-collection-ai-art-quantum). The idea is simple, we
  initialize a series of qubits, in this case 5 which is a common number of q...
...
draft: false
featured: false
coverImage: 'https://i.ytimg.com/vi/q_oOZxcR1NA/hqdefault.jpg'
readingTime: 4 min
status: completed
tech:
  - IBM Quantum
...
media:
  ...
  - type: image
    ...
    alt: Quantum Random Number Generator image 1
---
