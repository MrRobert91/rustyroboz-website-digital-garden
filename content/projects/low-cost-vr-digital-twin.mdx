...
description: "An exploration of affordable digital twins using 3D scanning and Unity VR to recreate real places and objects as immersive virtual spaces."
...
draft: false
featured: true
coverImage: 'https://i.ytimg.com/vi/6N5dYCssoRk/hqdefault.jpg'
readingTime: 3 min
status: completed
tech:
  - Unity
  ...
  - Kiri Engine
links:
  Write-up: "/articles/low-cost-digital-twin"
  demo: 'https://rustyroboz.itch.io/low-cost-vr-digital-twin'
  video: 'https://www.youtube.com/channel/UC-BligqNSwG0krJDfaPhytw'
...
media:
  - type: youtube
    ...
    title: Low Cost VR Digital Twin
  - type: image
    src: /images/projects/low-cost-vr-digital-twin/image-01.png
    alt: Low Cost VR Digital Twin image 1
  - type: image
    src: /images/projects/low-cost-vr-digital-twin/image-02.png
    alt: Low Cost VR Digital Twin image 2
  - type: image
    src: /images/projects/low-cost-vr-digital-twin/image-03.png
    alt: Low Cost VR Digital Twin image 3
  - type: image
    src: /images/projects/low-cost-vr-digital-twin/image-04.png
    alt: Low Cost VR Digital Twin image 4
---
...
You can download it for free at: [https://rustyroboz.itch.io/low-cost-vr-digital-twin](https://rustyroboz.itch.io/low-cost-vr-digital-twin)
