...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="interactive-control grid size-11 shrink-0 place-items-center rounded-full border border-control-border text-muted-foreground transition-colors hover:text-accent"
      onClick={toggle}
